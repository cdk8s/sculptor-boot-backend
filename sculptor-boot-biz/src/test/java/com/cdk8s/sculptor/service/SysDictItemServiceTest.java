 ...
 * All rights reserved.
 * 文件名称：SysDictItemServiceTest.java
...
public class SysDictItemServiceTest {
	...
	public void a_findOneById() {
		...
		SysDictItem result = sysDictItemService.findOneById(serviceBO);
	...
	public void a_findListByIdList() {
		...
		List<SysDictItem> result = sysDictItemService.findListByIdList(serviceBO);
	...
	public void a_create() {
		...
		serviceBO.setId(ID);
		serviceBO.setDictId(RandomUtil.nextLong(1, 10));
		...
		serviceBO.setDictValueTypeEnum(DictValueTypeEnum.getRandomEnum().getCode());
