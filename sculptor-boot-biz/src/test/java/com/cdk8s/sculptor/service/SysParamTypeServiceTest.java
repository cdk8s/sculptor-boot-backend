 ...
 * All rights reserved.
 * 文件名称：SysParamTypeServiceTest.java
...
public class SysParamTypeServiceTest {
	...
	public void a_findOneById() {
		...
		SysParamType result = sysParamTypeService.findOneById(serviceBO);
	...
	public void a_findListByIdList() {
		...
		List<SysParamType> result = sysParamTypeService.findListByIdList(serviceBO);
