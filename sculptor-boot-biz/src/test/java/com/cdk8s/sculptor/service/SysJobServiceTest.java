...
import com.cdk8s.sculptor.pojo.bo.service.sysjob.SysJobPageQueryServiceBO;
...
public class SysJobServiceTest {
	...
	public void a_findOneById() {
		...
		SysJob result = sysJobService.findOneById(serviceBO);
	...
	public void a_findListByIdList() {
		...
		List<SysJob> result = sysJobService.findListByIdList(serviceBO);
	...
	public void a_findListByServiceBO() {
		SysJobPageQueryServiceBO serviceBO = new SysJobPageQueryServiceBO();
		...
		List<SysJob> result = sysJobService.findListByServiceBO(serviceBO);
	...
	public void a_findPageByServiceBO() {
		...
		PageInfo result = sysJobService.findPageByServiceBO(serviceBO);
	...
	public void a_create() {
		...
		SysJobCreateServiceBO serviceBO = new SysJobCreateServiceBO();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		serviceBO.setId(ID);
		serviceBO.setJobName(RandomUtil.randomAlphabetic(6));
		serviceBO.setJobGroup(RandomUtil.randomAlphabetic(6));
		serviceBO.setInvokeTarget(RandomUtil.randomAlphabetic(6));
		serviceBO.setCronExpression(RandomUtil.randomAlphabetic(6));
		serviceBO.setMisfirePolicyEnum(MisfirePolicyEnum.getRandomEnum().getCode());
		serviceBO.setBoolSupportConcurrentEnum(BooleanEnum.getRandomEnum().getCode());
		...
		Integer result = sysJobService.create(serviceBO);
	...
	public void b_update() {
		...
		SysJobUpdateServiceBO serviceBO = new SysJobUpdateServiceBO();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		serviceBO.setId(ID);
		serviceBO.setJobName(RandomUtil.randomAlphabetic(6));
		serviceBO.setJobGroup(RandomUtil.randomAlphabetic(6));
		...
		Integer result = sysJobService.update(serviceBO);
	...
	public void b_batchUpdateState() {
		...
		Integer result = sysJobService.batchUpdateState(serviceBO);
	...
	public void m_batchDelete() {
		...
		Integer result = sysJobService.batchDelete(serviceBO);
