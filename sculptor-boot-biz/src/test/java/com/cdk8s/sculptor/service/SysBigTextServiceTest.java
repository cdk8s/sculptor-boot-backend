 ...
 * All rights reserved.
 * 文件名称：SysBigTextServiceTest.java
...
import com.cdk8s.sculptor.pojo.bo.service.sysbigtext.SysBigTextCreateServiceBO;
import com.cdk8s.sculptor.pojo.bo.service.sysbigtext.SysBigTextPageQueryServiceBO;
import com.cdk8s.sculptor.pojo.bo.service.sysbigtext.SysBigTextUpdateServiceBO;
...
public class SysBigTextServiceTest {
	...
	public void a_findOneById() {
		...
		SysBigText result = sysBigTextService.findOneById(serviceBO);
	...
	public void a_findListByIdList() {
		...
		List<SysBigText> result = sysBigTextService.findListByIdList(serviceBO);
	...
	public void a_findListByServiceBO() {
		SysBigTextPageQueryServiceBO serviceBO = new SysBigTextPageQueryServiceBO();
		...
		List<SysBigText> result = sysBigTextService.findListByServiceBO(serviceBO);
	...
	public void a_findPageByServiceBO() {
		...
		PageInfo result = sysBigTextService.findPageByServiceBO(serviceBO);
	...
	public void a_create() {
		...
		SysBigTextCreateServiceBO serviceBO = new SysBigTextCreateServiceBO();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		serviceBO.setId(ID);
		serviceBO.setTextTitle(RandomUtil.randomAlphabetic(6));
		serviceBO.setTextCode(RandomUtil.randomAlphabetic(6));
		serviceBO.setTextContent(RandomUtil.randomAlphabetic(6));
		serviceBO.setStateEnum(StateEnum.ENABLE.getCode());
		...
		Integer result = sysBigTextService.create(serviceBO);
	...
	public void b_update() {
		...
		SysBigTextUpdateServiceBO serviceBO = new SysBigTextUpdateServiceBO();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		serviceBO.setId(ID);
		serviceBO.setTextTitle(RandomUtil.randomAlphabetic(6));
		serviceBO.setTextCode(RandomUtil.randomAlphabetic(6));
		...
		Integer result = sysBigTextService.update(serviceBO);
	...
	public void b_batchUpdateState() {
		...
		Integer result = sysBigTextService.batchUpdateState(serviceBO);
	...
	public void m_batchDelete() {
		...
		Integer result = sysBigTextService.batchDelete(serviceBO);
