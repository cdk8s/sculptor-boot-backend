 ...
 * All rights reserved.
 * 文件名称：SysLoginLogServiceTest.java
...
public class SysLoginLogServiceTest {
	...
	public void a_findOneById() {
		...
		SysLoginLog result = sysLoginLogService.findOneById(serviceBO);
	...
	public void a_findListByIdList() {
		...
		List<SysLoginLog> result = sysLoginLogService.findListByIdList(serviceBO);
	...
	public void a_create() {
		...
		serviceBO.setBoolLoginSuccessEnum(BooleanEnum.getRandomEnum().getCode());
		serviceBO.setBoolNowOnlineEnum(BooleanEnum.getRandomEnum().getCode());
		serviceBO.setBoolNewUserEnum(BooleanEnum.getRandomEnum().getCode());
		serviceBO.setLoginOriginEnum(LoginOriginEnum.getRandomEnum().getCode());
