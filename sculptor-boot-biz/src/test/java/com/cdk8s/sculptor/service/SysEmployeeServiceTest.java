 ...
 * All rights reserved.
 * 文件名称：SysEmployeeServiceTest.java
...
public class SysEmployeeServiceTest {
	...
	public void a_findOneById() {
		...
		SysEmployee result = sysEmployeeService.findOneById(serviceBO);
	...
	public void a_findListByIdList() {
		...
		List<SysEmployee> result = sysEmployeeService.findListByIdList(serviceBO);
