 ...
 * All rights reserved.
 * 文件名称：RelDeptUserServiceTest.java
...
public class RelDeptUserServiceTest {
	...
	public void a_findOneById() {
		...
		RelDeptUser result = relDeptUserService.findOneById(serviceBO);
	...
	public void a_findListByIdList() {
		...
		List<RelDeptUser> result = relDeptUserService.findListByIdList(serviceBO);
	...
	public void a_findListByServiceBO() {
		RelDeptUserPageQueryServiceBO serviceBO = new RelDeptUserPageQueryServiceBO();
		serviceBO.setCreateDateStartDate(631183520000L);
		serviceBO.setCreateDateEndDate(1893487520000L);

		List<RelDeptUser> result = relDeptUserService.findListByServiceBO(serviceBO);
	...
	public void a_findPageByServiceBO() {
		...
		PageInfo result = relDeptUserService.findPageByServiceBO(serviceBO);
	...
	public void a_create() {
		...
		RelDeptUserCreateServiceBO serviceBO = new RelDeptUserCreateServiceBO();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		serviceBO.setId(ID);
		serviceBO.setDeptId(RandomUtil.nextLong(1, 10));
		...
		Integer result = relDeptUserService.create(serviceBO);
	...
	public void b_update() {
		...
		RelDeptUserUpdateServiceBO serviceBO = new RelDeptUserUpdateServiceBO();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		serviceBO.setId(ID);
		serviceBO.setDeptId(RandomUtil.nextLong(1, 10));
		serviceBO.setUserId(RandomUtil.nextLong(1, 10));
		...
		Integer result = relDeptUserService.update(serviceBO);
	...
	public void m_batchDelete() {
		...
		Integer result = relDeptUserService.batchDelete(serviceBO);
