 ...
 * All rights reserved.
 * 文件名称：RelPermissionRoleServiceTest.java
...
public class RelPermissionRoleServiceTest {
	...
	public void a_findOneById() {
		...
		RelPermissionRole result = relPermissionRoleService.findOneById(serviceBO);
	...
	public void a_findListByIdList() {
		...
		List<RelPermissionRole> result = relPermissionRoleService.findListByIdList(serviceBO);
	...
	public void a_findListByServiceBO() {
		RelPermissionRolePageQueryServiceBO serviceBO = new RelPermissionRolePageQueryServiceBO();
		serviceBO.setCreateDateStartDate(631183520000L);
		serviceBO.setCreateDateEndDate(1893487520000L);

		List<RelPermissionRole> result = relPermissionRoleService.findListByServiceBO(serviceBO);
	...
	public void a_findPageByServiceBO() {
		...
		PageInfo result = relPermissionRoleService.findPageByServiceBO(serviceBO);
	...
	public void a_create() {
		...
		RelPermissionRoleCreateServiceBO serviceBO = new RelPermissionRoleCreateServiceBO();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		serviceBO.setId(ID);
		serviceBO.setPermissionId(RandomUtil.nextLong(1, 10));
		serviceBO.setRoleId(RandomUtil.nextLong(1, 10));

		serviceBO.setCreateDate(currentEpochMilli);
		serviceBO.setCreateUserId(currentUserId);

		Integer result = relPermissionRoleService.create(serviceBO);
	...
	public void b_update() {
		...
		RelPermissionRoleUpdateServiceBO serviceBO = new RelPermissionRoleUpdateServiceBO();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		serviceBO.setId(ID);
		serviceBO.setPermissionId(RandomUtil.nextLong(1, 10));
		serviceBO.setRoleId(RandomUtil.nextLong(1, 10));
		...
		Integer result = relPermissionRoleService.update(serviceBO);
	...
	public void m_batchDelete() {
		...
		Integer result = relPermissionRoleService.batchDelete(serviceBO);
