...
public class SysUserServiceTest {
	...
	public void a_findOneById() {
		...
		SysUser result = sysUserService.findOneById(serviceBO);
	...
	public void a_findListByIdList() {
		...
		List<SysUser> result = sysUserService.findListByIdList(serviceBO);
	...
	public void a_create() {
		...
		serviceBO.setUserPassword(RandomUtil.randomAlphabetic(6));
		serviceBO.setPasswordSalt(RandomUtil.randomAlphabetic(6));
		serviceBO.setGenderEnum(GenderEnum.getRandomEnum().getCode());
		serviceBO.setUserTypeEnum(UserTypeEnum.getRandomEnum().getCode());
		serviceBO.setRegisterTypeEnum(RegisterTypeEnum.getRandomEnum().getCode());
		serviceBO.setRegisterOriginEnum(RegisterOriginEnum.getRandomEnum().getCode());
		serviceBO.setStateEnum(StateEnum.ENABLE.getCode());
