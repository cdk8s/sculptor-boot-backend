 ...
 * All rights reserved.
 * 文件名称：SysDictItemMapperTest.java
...
public class SysDictItemMapperTest {
	...
	public void a_selectById() {
		SysDictItem result = sysDictItemMapper.selectById(new IdMapperBO(ID));
	...
	public void a_selectByIdList() {
		...
		List<SysDictItem> result = sysDictItemMapper.selectByIdList(new IdListMapperBO(idList));
	...
	public void a_selectAll() {
		List<SysDictItem> result = sysDictItemMapper.selectAll();
	...
	public void a_selectByPageQueryMapperBo() {
		SysDictItemPageQueryMapperBO mapperBO = new SysDictItemPageQueryMapperBO();
		...
		List<SysDictItem> result = sysDictItemMapper.selectByPageQueryMapperBo(mapperBO);
	...
	public void a_selectByStateEnum() {
		...
		List<SysDictItem> result = sysDictItemMapper.selectByStateEnum(bo);
	...
	public void a_selectByDeleteEnum() {
		...
		List<SysDictItem> result = sysDictItemMapper.selectByDeleteEnum(bo);
	...
	public void a_selectByDeleteEnumAndStateEnum() {
		...
		List<SysDictItem> result = sysDictItemMapper.selectByDeleteEnumAndStateEnum(bo);
	...
	public void a_batchCreate() {
		...
		List<SysDictItem> entityList = new ArrayList<>();
		for (int i = 0; i < 13; i++) {
			SysDictItem entity = new SysDictItem();
			// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
			entity.setId(ID + i);
			entity.setDictId(RandomUtil.nextLong(1, 10));
			entity.setDictCode(RandomUtil.randomAlphabetic(6));
			entity.setItemName(RandomUtil.randomAlphabetic(6));
			entity.setItemCode(RandomUtil.randomAlphabetic(6));
			entity.setDictValueTypeEnum(DictValueTypeEnum.getRandomEnum().getCode());
			entity.setRanking(100);
			entity.setStateEnum(StateEnum.ENABLE.getCode());
			entity.setTenantId(RandomUtil.nextLong(1, 10));

			entity.setItemValue(RandomUtil.randomAlphabetic(6));
		...
		int result = sysDictItemMapper.batchInsertList(entityList);
	...
	public void b_updateStateEnumByIdList() {
		...
		int result = sysDictItemMapper.updateStateEnumByIdList(bo);
	...
	public void m_updateDeleteEnumByIdList() {
		...
		int result = sysDictItemMapper.updateDeleteEnumByIdList(bo);
