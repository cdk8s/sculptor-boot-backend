 ...
 * All rights reserved.
 * 文件名称：SysPermissionMapperTest.java
...
public class SysPermissionMapperTest {
	...
	public void a_batchCreate() {
		...
		for (int i = 0; i < 13; i++) {
			...
			entity.setBelongTypeEnum(BelongTypeEnum.getRandomEnum().getCode());
			entity.setPermissionTypeEnum(PermissionTypeEnum.getRandomEnum().getCode());
			entity.setParentId(1L);
			entity.setParentIds("1");
			entity.setVisibleEnum(VisibleEnum.getRandomEnum().getCode());
			entity.setBoolExtLinkEnum(BooleanEnum.getRandomEnum().getCode());
			entity.setBoolNewTabEnum(BooleanEnum.getRandomEnum().getCode());
