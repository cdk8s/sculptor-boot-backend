...
public class SysParamMapperTest {
	...
	public void a_selectById() {
		SysParam result = sysParamMapper.selectById(new IdMapperBO(ID));
	...
	public void a_selectByIdList() {
		...
		List<SysParam> result = sysParamMapper.selectByIdList(new IdListMapperBO(idList));
	...
	public void a_selectAll() {
		List<SysParam> result = sysParamMapper.selectAll();
	...
	public void a_selectByPageQueryMapperBo() {
		SysParamPageQueryMapperBO mapperBO = new SysParamPageQueryMapperBO();
		...
		List<SysParam> result = sysParamMapper.selectByPageQueryMapperBo(mapperBO);
	...
	public void a_selectByStateEnum() {
		...
		List<SysParam> result = sysParamMapper.selectByStateEnum(bo);
	...
	public void a_selectByDeleteEnum() {
		...
		List<SysParam> result = sysParamMapper.selectByDeleteEnum(bo);
	...
	public void a_selectByDeleteEnumAndStateEnum() {
		...
		List<SysParam> result = sysParamMapper.selectByDeleteEnumAndStateEnum(bo);
	...
	public void a_batchCreate() {
		...
		List<SysParam> entityList = new ArrayList<>();
		for (int i = 0; i < 13; i++) {
			SysParam entity = new SysParam();
			// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
			entity.setId(ID + i);
			entity.setTypeId(RandomUtil.nextLong(1, 10));
			entity.setTypeCode(RandomUtil.randomAlphabetic(6));
			entity.setParamName(RandomUtil.randomAlphabetic(6));
			entity.setParamCode(RandomUtil.randomAlphabetic(6));
			entity.setRanking(100);
			entity.setParamValueTypeEnum(ParamValueTypeEnum.getRandomEnum().getCode());
			entity.setStateEnum(StateEnum.ENABLE.getCode());
			entity.setTenantId(RandomUtil.nextLong(1, 10));

			entity.setParamValue(RandomUtil.randomAlphabetic(6));
		...
		int result = sysParamMapper.batchInsertList(entityList);
	...
	public void b_updateStateEnumByIdList() {
		...
		int result = sysParamMapper.updateStateEnumByIdList(bo);
	...
	public void m_updateDeleteEnumByIdList() {
		...
		int result = sysParamMapper.updateDeleteEnumByIdList(bo);
