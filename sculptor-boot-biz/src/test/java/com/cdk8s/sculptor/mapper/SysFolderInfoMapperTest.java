 ...
 * All rights reserved.
 * 文件名称：SysFolderInfoMapperTest.java
...
public class SysFolderInfoMapperTest {
	...
	public void a_selectById() {
		SysFolderInfo result = sysFolderInfoMapper.selectById(new IdMapperBO(ID));
	...
	public void a_selectByIdList() {
		...
		List<SysFolderInfo> result = sysFolderInfoMapper.selectByIdList(new IdListMapperBO(idList));
	...
	public void a_selectAll() {
		List<SysFolderInfo> result = sysFolderInfoMapper.selectAll();
	...
	public void a_selectByPageQueryMapperBo() {
		SysFolderInfoPageQueryMapperBO mapperBO = new SysFolderInfoPageQueryMapperBO();
		...
		List<SysFolderInfo> result = sysFolderInfoMapper.selectByPageQueryMapperBo(mapperBO);
	...
	public void a_selectByStateEnum() {
		...
		List<SysFolderInfo> result = sysFolderInfoMapper.selectByStateEnum(bo);
	...
	public void a_selectByDeleteEnum() {
		...
		List<SysFolderInfo> result = sysFolderInfoMapper.selectByDeleteEnum(bo);
	...
	public void a_selectByDeleteEnumAndStateEnum() {
		...
		List<SysFolderInfo> result = sysFolderInfoMapper.selectByDeleteEnumAndStateEnum(bo);
	...
	public void a_batchCreate() {
		...
		List<SysFolderInfo> entityList = new ArrayList<>();
		for (int i = 0; i < 13; i++) {
			SysFolderInfo entity = new SysFolderInfo();
			// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
			entity.setId(ID + i);
			entity.setParentId(1L);
			entity.setParentIds("1");
			entity.setFolderName(RandomUtil.randomAlphabetic(6));
		...
		int result = sysFolderInfoMapper.batchInsertList(entityList);
	...
	public void b_updateStateEnumByIdList() {
		...
		int result = sysFolderInfoMapper.updateStateEnumByIdList(bo);
	...
	public void m_updateDeleteEnumByIdList() {
		...
		int result = sysFolderInfoMapper.updateDeleteEnumByIdList(bo);
