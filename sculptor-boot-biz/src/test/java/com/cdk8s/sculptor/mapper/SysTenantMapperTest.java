...
public class SysTenantMapperTest {
	...
	public void a_selectById() {
		SysTenant result = sysTenantMapper.selectById(new IdMapperBO(ID));
	...
	public void a_selectByIdList() {
		...
		List<SysTenant> result = sysTenantMapper.selectByIdList(new IdListMapperBO(idList));
	...
	public void a_selectAll() {
		List<SysTenant> result = sysTenantMapper.selectAll();
	...
	public void a_selectByPageQueryMapperBo() {
		SysTenantPageQueryMapperBO mapperBO = new SysTenantPageQueryMapperBO();
		...
		List<SysTenant> result = sysTenantMapper.selectByPageQueryMapperBo(mapperBO);
	...
	public void a_selectByStateEnum() {
		...
		List<SysTenant> result = sysTenantMapper.selectByStateEnum(bo);
	...
	public void a_selectByDeleteEnum() {
		...
		List<SysTenant> result = sysTenantMapper.selectByDeleteEnum(bo);
	...
	public void a_selectByDeleteEnumAndStateEnum() {
		...
		List<SysTenant> result = sysTenantMapper.selectByDeleteEnumAndStateEnum(bo);
	...
	public void a_batchCreate() {
		...
		List<SysTenant> entityList = new ArrayList<>();
		for (int i = 0; i < 13; i++) {
			SysTenant entity = new SysTenant();
			// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
			entity.setId(ID + i);
			entity.setTenantName(RandomUtil.randomAlphabetic(6));
			entity.setTenantCode(RandomUtil.randomAlphabetic(6));
		...
		int result = sysTenantMapper.batchInsertList(entityList);
	...
	public void b_updateStateEnumByIdList() {
		...
		int result = sysTenantMapper.updateStateEnumByIdList(bo);
	...
	public void m_updateDeleteEnumByIdList() {
		...
		int result = sysTenantMapper.updateDeleteEnumByIdList(bo);
