...
public class SysUserMapperTest {
	...
	public void a_batchCreate() {
		...
		for (int i = 0; i < 13; i++) {
			...
			entity.setUserPassword(RandomUtil.randomAlphabetic(6));
			entity.setPasswordSalt(RandomUtil.randomAlphabetic(6));
			entity.setGenderEnum(GenderEnum.getRandomEnum().getCode());
			entity.setUserTypeEnum(UserTypeEnum.getRandomEnum().getCode());
			entity.setTenantId(RandomUtil.nextLong(1, 10));
			entity.setRegisterTypeEnum(RegisterTypeEnum.getRandomEnum().getCode());
			entity.setRegisterOriginEnum(RegisterOriginEnum.getRandomEnum().getCode());
			entity.setStateEnum(StateEnum.ENABLE.getCode());

			entity.setNickname(RandomUtil.randomAlphabetic(6));
			entity.setRealName(RandomUtil.randomAlphabetic(6));
			entity.setUserEmail(RandomUtil.randomAlphabetic(6));
			entity.setTelephone(RandomUtil.randomAlphabetic(6));
			entity.setMobilePhone(RandomUtil.randomAlphabetic(6));
			entity.setAvatarUrl(RandomUtil.randomAlphabetic(6));
