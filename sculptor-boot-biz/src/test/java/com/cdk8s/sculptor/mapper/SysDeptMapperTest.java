...
public class SysDeptMapperTest {
	...
	public void a_selectById() {
		SysDept result = sysDeptMapper.selectById(new IdMapperBO(ID));
	...
	public void a_selectByIdList() {
		...
		List<SysDept> result = sysDeptMapper.selectByIdList(new IdListMapperBO(idList));
	...
	public void a_selectAll() {
		List<SysDept> result = sysDeptMapper.selectAll();
	...
	public void a_selectByPageQueryMapperBo() {
		SysDeptPageQueryMapperBO mapperBO = new SysDeptPageQueryMapperBO();
		...
		List<SysDept> result = sysDeptMapper.selectByPageQueryMapperBo(mapperBO);
	...
	public void a_selectByStateEnum() {
		...
		List<SysDept> result = sysDeptMapper.selectByStateEnum(bo);
	...
	public void a_selectByDeleteEnum() {
		...
		List<SysDept> result = sysDeptMapper.selectByDeleteEnum(bo);
	...
	public void a_selectByDeleteEnumAndStateEnum() {
		...
		List<SysDept> result = sysDeptMapper.selectByDeleteEnumAndStateEnum(bo);
	...
	public void a_batchCreate() {
		...
		for (int i = 0; i < 13; i++) {
			...
			entity.setId(ID + i);
			entity.setDeptName(RandomUtil.randomAlphabetic(6));
			entity.setDeptCode(RandomUtil.randomAlphabetic(6));
			...
			entity.setLeaderUserId(RandomUtil.nextLong(1, 10));
			entity.setTelephone(RandomUtil.randomAlphabetic(6));
			entity.setMobilePhone(RandomUtil.randomAlphabetic(6));
			entity.setDeptFax(RandomUtil.randomAlphabetic(6));
			entity.setDeptAddress(RandomUtil.randomAlphabetic(6));
		...
		int result = sysDeptMapper.batchInsertList(entityList);
	...
	public void b_updateStateEnumByIdList() {
		...
		int result = sysDeptMapper.updateStateEnumByIdList(bo);
	...
	public void m_updateDeleteEnumByIdList() {
		...
		int result = sysDeptMapper.updateDeleteEnumByIdList(bo);
