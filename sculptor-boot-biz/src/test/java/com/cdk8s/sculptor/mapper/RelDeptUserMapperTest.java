 ...
 * All rights reserved.
 * 文件名称：RelDeptUserMapperTest.java
...
public class RelDeptUserMapperTest {
	...
	public void a_selectById() {
		RelDeptUser result = relDeptUserMapper.selectById(new IdMapperBO(ID));
	...
	public void a_selectByIdList() {
		...
		List<RelDeptUser> result = relDeptUserMapper.selectByIdList(new IdListMapperBO(idList));
	...
	public void a_selectAll() {
		List<RelDeptUser> result = relDeptUserMapper.selectAll();
	...
	public void a_selectByPageQueryMapperBo() {
		RelDeptUserPageQueryMapperBO mapperBO = new RelDeptUserPageQueryMapperBO();
		mapperBO.setCreateDateStartDate(631183520000L);
		mapperBO.setCreateDateEndDate(1893487520000L);

		List<RelDeptUser> result = relDeptUserMapper.selectByPageQueryMapperBo(mapperBO);
	...
	public void a_batchCreate() {
		...
		for (int i = 0; i < 13; i++) {
			RelDeptUser entity = new RelDeptUser();
			// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
			entity.setId(ID + i);
			entity.setDeptId(RandomUtil.nextLong(1, 10));
		...
		int result = relDeptUserMapper.batchInsertList(entityList);
	...
	public void m_deleteByIdList() {
		...
		int result = relDeptUserMapper.deleteByIdList(bo);
