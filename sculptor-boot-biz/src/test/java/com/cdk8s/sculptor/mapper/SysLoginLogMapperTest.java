 ...
 * All rights reserved.
 * 文件名称：SysLoginLogMapperTest.java
...
public class SysLoginLogMapperTest {
	...
	public void a_batchCreate() {
		...
		for (int i = 0; i < 13; i++) {
			...
			entity.setBoolLoginSuccessEnum(BooleanEnum.getRandomEnum().getCode());
			entity.setBoolNowOnlineEnum(BooleanEnum.getRandomEnum().getCode());
			entity.setTenantId(RandomUtil.nextLong(1, 10));
			entity.setBoolNewUserEnum(BooleanEnum.getRandomEnum().getCode());
			entity.setLoginOriginEnum(LoginOriginEnum.getRandomEnum().getCode());
			...
			entity.setLoginDate(RandomUtil.nextLong(1, 10));
			entity.setLogoutDate(RandomUtil.nextLong(1, 10));
			entity.setRequestUrl(RandomUtil.randomAlphabetic(6));
			entity.setOfflineTypeEnum(RandomUtil.nextInt(1, 10));
