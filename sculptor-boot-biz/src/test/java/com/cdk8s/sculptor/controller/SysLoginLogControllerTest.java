 ...
 * All rights reserved.
 * 文件名称：SysLoginLogControllerTest.java
...
public class SysLoginLogControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "sysLoginLog";
	...
	@Test
	public void a_list() {
		SysLoginLogPageQueryParam param = new SysLoginLogPageQueryParam();
	...
	public void a_create() {
		SysLoginLogCreateRequestParam param = new SysLoginLogCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setUserId(RandomUtil.nextLong(1, 10));
		param.setUsername(RandomUtil.randomAlphabetic(6));
		param.setBoolLoginSuccessEnum(BooleanEnum.getRandomEnum().getCode());
		param.setBoolNowOnlineEnum(BooleanEnum.getRandomEnum().getCode());
		param.setBoolNewUserEnum(BooleanEnum.getRandomEnum().getCode());
		param.setLoginOriginEnum(LoginOriginEnum.getRandomEnum().getCode());
	...
	public void b_update() {
		SysLoginLogUpdateRequestParam param = new SysLoginLogUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setUserId(RandomUtil.nextLong(1, 10));
		param.setUsername(RandomUtil.randomAlphabetic(6));
