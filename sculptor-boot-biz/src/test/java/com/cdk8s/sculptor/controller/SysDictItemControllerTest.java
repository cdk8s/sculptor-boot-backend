 ...
 * All rights reserved.
 * 文件名称：SysDictItemControllerTest.java
...
public class SysDictItemControllerTest {
	...
	private static final String MODULE_NAME = "sysDictItem";
	...
	@Test
	public void a_list() {
		SysDictItemPageQueryParam param = new SysDictItemPageQueryParam();
	...
	public void a_create() {
		SysDictItemCreateRequestParam param = new SysDictItemCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setDictId(RandomUtil.nextLong(1, 10));
		param.setDictCode(RandomUtil.randomAlphabetic(6));
		param.setItemName(RandomUtil.randomAlphabetic(6));
		param.setItemCode(RandomUtil.randomAlphabetic(6));
		param.setDictValueTypeEnum(DictValueTypeEnum.getRandomEnum().getCode());
	...
	public void b_update() {
		SysDictItemUpdateRequestParam param = new SysDictItemUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setDictId(RandomUtil.nextLong(1, 10));
		param.setDictCode(RandomUtil.randomAlphabetic(6));
