 ...
 * All rights reserved.
 * 文件名称：SysJobControllerTest.java
...
import com.cdk8s.sculptor.pojo.dto.param.sysjob.SysJobCreateRequestParam;
import com.cdk8s.sculptor.pojo.dto.param.sysjob.SysJobPageQueryParam;
import com.cdk8s.sculptor.pojo.dto.param.sysjob.SysJobUpdateRequestParam;
...
public class SysJobControllerTest {
	...
	private static final String MODULE_NAME = "sysJob";
	...
	@Test
	public void a_list() {
		SysJobPageQueryParam param = new SysJobPageQueryParam();
	...
	public void a_create() {
		SysJobCreateRequestParam param = new SysJobCreateRequestParam();
		...
		param.setMisfirePolicyEnum(MisfirePolicyEnum.getRandomEnum().getCode());
		param.setBoolSupportConcurrentEnum(BooleanEnum.getRandomEnum().getCode());
	...
	public void b_update() {
		SysJobUpdateRequestParam param = new SysJobUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setJobName(RandomUtil.randomAlphabetic(6));
		param.setJobGroup(RandomUtil.randomAlphabetic(6));
