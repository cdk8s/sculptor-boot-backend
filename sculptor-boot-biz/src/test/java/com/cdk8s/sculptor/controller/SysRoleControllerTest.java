 ...
 * All rights reserved.
 * 文件名称：SysRoleControllerTest.java
...
public class SysRoleControllerTest {
	...
	private static final String MODULE_NAME = "sysRole";
	...
	@Test
	public void a_list() {
		SysRolePageQueryParam param = new SysRolePageQueryParam();
	...
	public void a_create() {
		SysRoleCreateRequestParam param = new SysRoleCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setRoleName(RandomUtil.randomAlphabetic(6));
		param.setRoleCode(RandomUtil.randomAlphabetic(6));
		param.setRanking(100);
		param.setBoolTemplateEnum(BooleanEnum.getRandomEnum().getCode());
		param.setStateEnum(StateEnum.ENABLE.getCode());
	...
	public void b_update() {
		SysRoleUpdateRequestParam param = new SysRoleUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setRoleName(RandomUtil.randomAlphabetic(6));
		param.setRoleCode(RandomUtil.randomAlphabetic(6));
