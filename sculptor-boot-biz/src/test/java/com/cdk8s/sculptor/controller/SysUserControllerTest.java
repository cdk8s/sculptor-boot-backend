 ...
 * All rights reserved.
 * 文件名称：SysUserControllerTest.java
...
public class SysUserControllerTest {
	...
	public void a_create() {
		...
		param.setUserPassword(RandomUtil.randomAlphabetic(6));
		param.setGenderEnum(GenderEnum.getRandomEnum().getCode());
		param.setUserTypeEnum(UserTypeEnum.getRandomEnum().getCode());
		param.setStateEnum(StateEnum.ENABLE.getCode());
	...
	public void b_update() {
		...
		param.setGenderEnum(GenderEnum.getRandomEnum().getCode());
		param.setUserTypeEnum(UserTypeEnum.getRandomEnum().getCode());
		param.setRegisterTypeEnum(RegisterTypeEnum.getRandomEnum().getCode());
		param.setRegisterOriginEnum(RegisterOriginEnum.getRandomEnum().getCode());
		param.setStateEnum(StateEnum.ENABLE.getCode());
