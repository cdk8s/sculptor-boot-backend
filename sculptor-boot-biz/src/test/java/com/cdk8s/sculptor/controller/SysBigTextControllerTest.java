 ...
 * All rights reserved.
 * 文件名称：SysBigTextControllerTest.java
...
import com.cdk8s.sculptor.pojo.dto.param.sysbigtext.SysBigTextCreateRequestParam;
import com.cdk8s.sculptor.pojo.dto.param.sysbigtext.SysBigTextPageQueryParam;
import com.cdk8s.sculptor.pojo.dto.param.sysbigtext.SysBigTextUpdateRequestParam;
...
public class SysBigTextControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "sysBigText";
	...
	@Test
	public void a_list() {
		SysBigTextPageQueryParam param = new SysBigTextPageQueryParam();
	...
	public void a_create() {
		SysBigTextCreateRequestParam param = new SysBigTextCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setTextTitle(RandomUtil.randomAlphabetic(6));
		param.setTextCode(RandomUtil.randomAlphabetic(6));
		param.setTextContent(RandomUtil.randomAlphabetic(6));
		param.setStateEnum(StateEnum.ENABLE.getCode());
	...
	public void b_update() {
		SysBigTextUpdateRequestParam param = new SysBigTextUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setTextTitle(RandomUtil.randomAlphabetic(6));
		param.setTextCode(RandomUtil.randomAlphabetic(6));
