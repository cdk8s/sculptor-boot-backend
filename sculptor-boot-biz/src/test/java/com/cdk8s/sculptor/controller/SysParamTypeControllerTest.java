 ...
 * All rights reserved.
 * 文件名称：SysParamTypeControllerTest.java
...
public class SysParamTypeControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "sysParamType";
	...
	@Test
	public void a_list() {
		SysParamTypePageQueryParam param = new SysParamTypePageQueryParam();
	...
	public void a_create() {
		SysParamTypeCreateRequestParam param = new SysParamTypeCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setTypeName(RandomUtil.randomAlphabetic(6));
		param.setTypeCode(RandomUtil.randomAlphabetic(6));
	...
	public void b_update() {
		SysParamTypeUpdateRequestParam param = new SysParamTypeUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setTypeName(RandomUtil.randomAlphabetic(6));
		param.setTypeCode(RandomUtil.randomAlphabetic(6));
