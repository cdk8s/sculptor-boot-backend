 ...
 * All rights reserved.
 * 文件名称：RelDeptUserControllerTest.java
...
public class RelDeptUserControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "relDeptUser";
	...
	@Test
	public void a_list() {
		RelDeptUserPageQueryParam param = new RelDeptUserPageQueryParam();
	...
	public void a_create() {
		RelDeptUserCreateRequestParam param = new RelDeptUserCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setDeptId(RandomUtil.nextLong(1, 10));
	...
	public void b_update() {
		RelDeptUserUpdateRequestParam param = new RelDeptUserUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setDeptId(RandomUtil.nextLong(1, 10));
		param.setUserId(RandomUtil.nextLong(1, 10));
