 ...
 * All rights reserved.
 * 文件名称：SysDictControllerTest.java
...
public class SysDictControllerTest {
	...
	private static final String MODULE_NAME = "sysDict";
	...
	@Test
	public void a_list() {
		SysDictPageQueryParam param = new SysDictPageQueryParam();
	...
	public void a_create() {
		SysDictCreateRequestParam param = new SysDictCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setDictName(RandomUtil.randomAlphabetic(6));
	...
	public void b_update() {
		SysDictUpdateRequestParam param = new SysDictUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setDictName(RandomUtil.randomAlphabetic(6));
		param.setDictCode(RandomUtil.randomAlphabetic(6));
