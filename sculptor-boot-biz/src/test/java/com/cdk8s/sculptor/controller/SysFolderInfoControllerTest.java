 ...
 * All rights reserved.
 * 文件名称：SysFolderInfoControllerTest.java
...
import com.cdk8s.sculptor.pojo.dto.param.sysfolderinfo.SysFolderInfoCreateRequestParam;
import com.cdk8s.sculptor.pojo.dto.param.sysfolderinfo.SysFolderInfoPageQueryParam;
import com.cdk8s.sculptor.pojo.dto.param.sysfolderinfo.SysFolderInfoUpdateRequestParam;
...
public class SysFolderInfoControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "sysFolderInfo";
	...
	@Test
	public void a_list() {
		SysFolderInfoPageQueryParam param = new SysFolderInfoPageQueryParam();
	...
	public void a_create() {
		SysFolderInfoCreateRequestParam param = new SysFolderInfoCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setParentId(1L);
		param.setFolderName(RandomUtil.randomAlphabetic(6));
	...
	public void b_update() {
		SysFolderInfoUpdateRequestParam param = new SysFolderInfoUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setParentId(1L);
		param.setFolderName(RandomUtil.randomAlphabetic(6));
