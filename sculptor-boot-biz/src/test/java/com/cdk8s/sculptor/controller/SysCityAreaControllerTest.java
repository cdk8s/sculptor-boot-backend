 ...
 * All rights reserved.
 * 文件名称：SysCityAreaControllerTest.java
...
public class SysCityAreaControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "sysCityArea";
	...
	@Test
	public void a_list() {
		SysCityAreaPageQueryParam param = new SysCityAreaPageQueryParam();
	...
	public void a_create() {
		SysCityAreaCreateRequestParam param = new SysCityAreaCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setParentId(1L);
		param.setAreaName(RandomUtil.randomAlphabetic(6));
	...
	public void b_update() {
		SysCityAreaUpdateRequestParam param = new SysCityAreaUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setParentId(1L);
		param.setAreaName(RandomUtil.randomAlphabetic(6));
