 ...
 * All rights reserved.
 * 文件名称：SysSmsLoginLogControllerTest.java
...
public class SysSmsLoginLogControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "sysSmsLoginLog";
	...
	@Test
	public void a_list() {
		SysSmsLoginLogPageQueryParam param = new SysSmsLoginLogPageQueryParam();
	...
	public void a_create() {
		SysSmsLoginLogCreateRequestParam param = new SysSmsLoginLogCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setUserId(RandomUtil.nextLong(1, 10));
		param.setUserMobilePhone(RandomUtil.randomAlphabetic(6));
		param.setVerificationCode(RandomUtil.randomAlphabetic(6));
		param.setSmsProviderTypeEnum(SmsProviderTypeEnum.getRandomEnum().getCode());
		param.setBoolServiceStateEnum(BooleanEnum.getRandomEnum().getCode());
		param.setMessageContent(RandomUtil.randomAlphabetic(6));
		param.setBoolUseEnum(BooleanEnum.getRandomEnum().getCode());
	...
	public void b_update() {
		SysSmsLoginLogUpdateRequestParam param = new SysSmsLoginLogUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setUserId(RandomUtil.nextLong(1, 10));
		param.setUserMobilePhone(RandomUtil.randomAlphabetic(6));
