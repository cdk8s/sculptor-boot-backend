 ...
 * All rights reserved.
 * 文件名称：AuthorizationCodeByHeaderTest.java
...
public class AuthorizationCodeByHeaderTest {
	...
	public void a_authorize() {
		RequestBuilder request = MockMvcRequestBuilders
				...
				.param("response_type", GlobalConstantToJunit.CODE_RESPONSE_TYPE)
				.param("client_id", GlobalConstantToJunit.CLIENT_ID)
	...
	public void b_formLogin() {
		RequestBuilder request = MockMvcRequestBuilders
				...
				.header("User-Agent", GlobalConstantToJunit.USER_AGENT)
				.param("response_type", GlobalConstantToJunit.CODE_RESPONSE_TYPE)
				.param("client_id", GlobalConstantToJunit.CLIENT_ID)
				.param("redirect_uri", REDIRECT_URI)
				.param("username", GlobalConstantToJunit.USERNAME)
				.param("password", GlobalConstantToJunit.PASSWORD)
				.accept(TEXT_MEDIA_TYPE)
				.contentType(DEFAULT_FORM_MEDIA_TYPE);
	...
	public void c_token() {
		RequestBuilder request = MockMvcRequestBuilders
				...
				.header("Authorization", GlobalConstantToJunit.HTTP_HEADER_BASIC_AUTHORIZATION)
				.param("grant_type", GlobalConstantToJunit.CODE_GRANT_TYPE)
				.param("client_id", GlobalConstantToJunit.CLIENT_ID)
				.param("redirect_uri", REDIRECT_URI)
				.param("code", GlobalConstantToJunit.CODE2)
	...
	public void d_userinfo() {
		RequestBuilder request = MockMvcRequestBuilders
				...
				.param("access_token", GlobalConstantToJunit.ACCESS_TOKEN)
				.accept(JSON_MEDIA_TYPE);
	...
	public void e_introspectByAccessToken() {
		RequestBuilder request = MockMvcRequestBuilders
				...
				.param("token", GlobalConstantToJunit.ACCESS_TOKEN)
				.accept(JSON_MEDIA_TYPE)
				.contentType(DEFAULT_FORM_MEDIA_TYPE);
	...
	public void f_introspectByRefreshToken() {
		RequestBuilder request = MockMvcRequestBuilders
				...
				.param("token", GlobalConstantToJunit.REFRESH_TOKEN)
				.accept(JSON_MEDIA_TYPE)
				.contentType(DEFAULT_FORM_MEDIA_TYPE);
