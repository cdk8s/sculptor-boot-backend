 ...
 * All rights reserved.
 * 文件名称：SysEmployeeControllerTest.java
...
public class SysEmployeeControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "sysEmployee";
	...
	@Test
	public void a_list() {
		SysEmployeePageQueryParam param = new SysEmployeePageQueryParam();
	...
	public void a_create() {
		SysEmployeeCreateRequestParam param = new SysEmployeeCreateRequestParam();
	...
	public void b_update() {
		SysEmployeeUpdateRequestParam param = new SysEmployeeUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setUserId(RandomUtil.nextLong(1, 10));
