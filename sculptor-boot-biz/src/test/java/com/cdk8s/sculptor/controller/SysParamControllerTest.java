 ...
 * All rights reserved.
 * 文件名称：SysParamControllerTest.java
...
public class SysParamControllerTest {
	...
	private static final String MODULE_NAME = "sysParam";
	...
	@Test
	public void a_list() {
		SysParamPageQueryParam param = new SysParamPageQueryParam();
	...
	public void a_create() {
		SysParamCreateRequestParam param = new SysParamCreateRequestParam();
		// 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setTypeId(111111111111111111L);
		param.setParamName(RandomUtil.randomAlphabetic(6));
		param.setParamCode(RandomUtil.randomAlphabetic(6));
		param.setRanking(100);
		param.setParamValueTypeEnum(ParamValueTypeEnum.String.getCode());
		param.setStateEnum(StateEnum.ENABLE.getCode());
	...
	public void b_update() {
		SysParamUpdateRequestParam param = new SysParamUpdateRequestParam();
		param.setId(ID);
		// 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setTypeId(111111111111111111L);
		param.setParamName(RandomUtil.randomAlphabetic(6));
