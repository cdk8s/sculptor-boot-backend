 ...
 * All rights reserved.
 * 文件名称：SysBannerControllerTest.java
...
import com.cdk8s.sculptor.pojo.dto.param.sysbanner.SysBannerCreateRequestParam;
import com.cdk8s.sculptor.pojo.dto.param.sysbanner.SysBannerPageQueryParam;
import com.cdk8s.sculptor.pojo.dto.param.sysbanner.SysBannerUpdateRequestParam;
...
public class SysBannerControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "sysBanner";
	...
	@Test
	public void a_list() {
		SysBannerPageQueryParam param = new SysBannerPageQueryParam();
	...
	public void a_create() {
		SysBannerCreateRequestParam param = new SysBannerCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setBannerTitle(RandomUtil.randomAlphabetic(6));
		param.setBannerStandDate(RandomUtil.nextBigDecimal(1, 100));
		param.setBannerJumpTypeEnum(BannerJumpTypeEnum.getRandomEnum().getCode());
	...
	public void b_update() {
		SysBannerUpdateRequestParam param = new SysBannerUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setBannerTitle(RandomUtil.randomAlphabetic(6));
		param.setBannerStandDate(RandomUtil.nextBigDecimal(1, 100));
