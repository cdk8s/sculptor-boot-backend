 ...
 * All rights reserved.
 * 文件名称：SysTenantControllerTest.java
...
import com.cdk8s.sculptor.pojo.dto.param.systenant.SysTenantCreateRequestParam;
import com.cdk8s.sculptor.pojo.dto.param.systenant.SysTenantPageQueryParam;
import com.cdk8s.sculptor.pojo.dto.param.systenant.SysTenantUpdateRequestParam;
...
public class SysTenantControllerTest {
	...
	private static final String MODULE_NAME = "sysTenant";
	...
	@Test
	public void a_list() {
		SysTenantPageQueryParam param = new SysTenantPageQueryParam();
	...
	public void a_create() {
		SysTenantCreateRequestParam param = new SysTenantCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setTenantName(RandomUtil.randomAlphabetic(6));
		param.setTenantCode(RandomUtil.randomAlphabetic(6));
		param.setStateEnum(StateEnum.ENABLE.getCode());
	...
	public void b_update() {
		SysTenantUpdateRequestParam param = new SysTenantUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setTenantName(RandomUtil.randomAlphabetic(6));
		param.setTenantCode(RandomUtil.randomAlphabetic(6));
