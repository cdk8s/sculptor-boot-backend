 ...
 * All rights reserved.
 * 文件名称：SysFileInfoControllerTest.java
...
import com.cdk8s.sculptor.enums.FileStorageTypeEnum;
...
import com.cdk8s.sculptor.pojo.dto.param.sysfileinfo.SysFileInfoCreateRequestParam;
import com.cdk8s.sculptor.pojo.dto.param.sysfileinfo.SysFileInfoPageQueryParam;
import com.cdk8s.sculptor.pojo.dto.param.sysfileinfo.SysFileInfoUpdateRequestParam;
...
public class SysFileInfoControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "sysFileInfo";
	...
	@Test
	public void a_list() {
		SysFileInfoPageQueryParam param = new SysFileInfoPageQueryParam();
	...
	public void a_create() {
		SysFileInfoCreateRequestParam param = new SysFileInfoCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setFolderId(RandomUtil.nextLong(1, 10));
		param.setFileShowName(RandomUtil.randomAlphabetic(6));
		param.setFileStorageName(RandomUtil.randomAlphabetic(6));
		param.setFileStoragePath(RandomUtil.randomAlphabetic(6));
		param.setFileStorageTypeEnum(FileStorageTypeEnum.getRandomEnum().getCode());
		param.setFileSize(RandomUtil.nextLong(1, 10));
		param.setRanking(100);
		param.setBoolTopEnum(BooleanEnum.getRandomEnum().getCode());
		param.setBoolOssCompleteEnum(BooleanEnum.getRandomEnum().getCode());
		param.setBoolOssDeleteEnum(BooleanEnum.getRandomEnum().getCode());
		param.setStateEnum(StateEnum.ENABLE.getCode());
	...
	public void b_update() {
		SysFileInfoUpdateRequestParam param = new SysFileInfoUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setFolderId(RandomUtil.nextLong(1, 10));
		param.setFileShowName(RandomUtil.randomAlphabetic(6));
