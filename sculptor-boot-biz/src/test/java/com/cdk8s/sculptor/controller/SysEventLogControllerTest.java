 ...
 * All rights reserved.
 * 文件名称：SysEventLogControllerTest.java
...
public class SysEventLogControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "sysEventLog";
	...
	@Test
	public void a_list() {
		SysEventLogPageQueryParam param = new SysEventLogPageQueryParam();
	...
	public void a_create() {
		SysEventLogCreateRequestParam param = new SysEventLogCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setBoolExecuteSuccessEnum(BooleanEnum.getRandomEnum().getCode());
		param.setOperateTypeEnum(OperateTypeEnum.getRandomEnum().getCode());
	...
	public void b_update() {
		SysEventLogUpdateRequestParam param = new SysEventLogUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setBoolExecuteSuccessEnum(BooleanEnum.getRandomEnum().getCode());
		param.setOperateTypeEnum(OperateTypeEnum.getRandomEnum().getCode());
