 ...
 * All rights reserved.
 * 文件名称：SysJobLogControllerTest.java
...
import com.cdk8s.sculptor.pojo.dto.param.sysjoblog.SysJobLogCreateRequestParam;
import com.cdk8s.sculptor.pojo.dto.param.sysjoblog.SysJobLogPageQueryParam;
import com.cdk8s.sculptor.pojo.dto.param.sysjoblog.SysJobLogUpdateRequestParam;
...
public class SysJobLogControllerTest {
	...
	private static final String MODULE_NAME = "sysJobLog";
	...
	@Test
	public void a_list() {
		SysJobLogPageQueryParam param = new SysJobLogPageQueryParam();
	...
	public void a_create() {
		SysJobLogCreateRequestParam param = new SysJobLogCreateRequestParam();
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setJobId(RandomUtil.nextLong(1, 10));
		param.setJobName(RandomUtil.randomAlphabetic(6));
		param.setJobGroup(RandomUtil.randomAlphabetic(6));
		param.setInvokeTarget(RandomUtil.randomAlphabetic(6));
		param.setCronExpression(RandomUtil.randomAlphabetic(6));
		param.setBoolExecuteSuccessEnum(BooleanEnum.getRandomEnum().getCode());
	...
	public void b_update() {
		SysJobLogUpdateRequestParam param = new SysJobLogUpdateRequestParam();
		param.setId(ID);
		// cdk8stodo 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setJobId(RandomUtil.nextLong(1, 10));
		param.setJobName(RandomUtil.randomAlphabetic(6));
