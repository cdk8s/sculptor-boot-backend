 ...
 * All rights reserved.
 * 文件名称：SysSmsLoginLogMapperExt.java
...
@Component
public interface SysSmsLoginLogMapperExt {

	// =====================================查询业务 start=====================================

	List<SysSmsLoginLog> selectByPageQueryMapperBoExt(SysSmsLoginLogPageQueryMapperBO mapperBO);
