 ...
 * All rights reserved.
 * 文件名称：SysSmsLoginLogController.java
...
import com.cdk8s.sculptor.controller.bases.SysSmsLoginLogControllerBase;
...
@Slf4j
@RestController
@RequestMapping("/api/sysSmsLoginLog")
public class SysSmsLoginLogController extends SysSmsLoginLogControllerBase {
