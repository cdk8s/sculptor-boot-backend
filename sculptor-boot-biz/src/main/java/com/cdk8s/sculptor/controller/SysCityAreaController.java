 ...
 * All rights reserved.
 * 文件名称：SysCityAreaController.java
...
import com.cdk8s.sculptor.controller.bases.SysCityAreaControllerBase;
...
@Slf4j
@RestController
@RequestMapping("/api/sysCityArea")
public class SysCityAreaController extends SysCityAreaControllerBase {
