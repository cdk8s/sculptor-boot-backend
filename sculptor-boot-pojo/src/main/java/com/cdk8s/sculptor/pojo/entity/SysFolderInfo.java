...
import com.cdk8s.sculptor.pojo.entity.bases.SysFolderInfoBase;
...
public class SysFolderInfo extends SysFolderInfoBase {
	...
	@Transient
	private List<SysFolderInfo> children;
