 ...
 * All rights reserved.
 * 文件名称：SysUserInfoBatchCreateRequestParam.java
...
public class SysUserInfoBatchCreateRequestParam extends BaseCreateParam {
	...
	private List<SysUserInfoCreateRequestParam> paramList;
