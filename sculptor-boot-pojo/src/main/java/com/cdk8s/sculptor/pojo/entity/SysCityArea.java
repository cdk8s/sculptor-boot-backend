...
import com.cdk8s.sculptor.pojo.entity.bases.SysCityAreaBase;
...
public class SysCityArea extends SysCityAreaBase {
	...
	@Transient
	private List<SysCityArea> children;
