 ...
 * All rights reserved.
 * 文件名称：SysPermissionPageQueryBaseMapperBO.java
 * 项目名称：sculptor-boot-pojo
 * 项目描述：简单类
 * 版权说明：本软件属CDK8S所有
 */

package com.cdk8s.sculptor.pojo.bo.mapper.syspermission.bases;
...
public class SysPermissionPageQueryBaseMapperBO extends PageParam {
