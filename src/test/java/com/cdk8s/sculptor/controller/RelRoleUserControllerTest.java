...
public class RelRoleUserControllerTest {

	private static final Long ID = GenerateIdUtil.getId();

	private static final String MODULE_NAME = "relRoleUser";
	...
	private static final String BATCH_CREATE_URL = "/api/" + MODULE_NAME + "/batchCreate";
	...
	@Test
	public void a_list() {
		RelRoleUserPageQueryParam param = new RelRoleUserPageQueryParam();
	...
	public void a_create() {
		RelRoleUserCreateRequestParam param = new RelRoleUserCreateRequestParam();
	...
	public void a_batchCreate() {
		RelRoleUserBatchCreateRequestParam param = new RelRoleUserBatchCreateRequestParam();
		// 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setUserIdList(Lists.newArrayList(111111111111111111L, 222222222222222222L));
		param.setRoleIdList(Lists.newArrayList(111111111111111111L, 222222222222222222L, 333333333333333333L));

		String jsonParam = JsonUtil.toJson(param);

		RequestBuilder request = MockMvcRequestBuilders
				.post(BATCH_CREATE_URL)
				.content(jsonParam)
				.accept(JSON_MEDIA_TYPE)
				.contentType(JSON_MEDIA_TYPE)
				.header(GlobalConstant.HEADER_TOKEN_KEY, GlobalConstantToJunit.ACCESS_TOKEN);
	...
	public void b_update() {
		RelRoleUserUpdateRequestParam param = new RelRoleUserUpdateRequestParam();
		param.setId(ID);
		// 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setRoleId(ID);
		param.setUserId(ID);
