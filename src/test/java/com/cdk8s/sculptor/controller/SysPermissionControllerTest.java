...
import com.cdk8s.sculptor.enums.PermissionTypeEnum;
import com.cdk8s.sculptor.enums.StateEnum;
import com.cdk8s.sculptor.enums.VisibleEnum;
...
public class SysPermissionControllerTest {
	...
	private static final String LIST_BY_PARENT_ID_URL = "/api/" + MODULE_NAME + "/listTreeByParentId";
	private static final String LIST_BY_PARENT_ID_NOT_BUTTON_URL = "/api/" + MODULE_NAME + "/listTreeByParentIdNotButton";
	...
	@SneakyThrows
	@Test
	public void a_listTreeByParentId() {

		RequestBuilder request = MockMvcRequestBuilders
				.get(LIST_BY_PARENT_ID_URL)
				.param("parentId", "1")
				.accept(JSON_MEDIA_TYPE)
				.contentType(DEFAULT_FORM_MEDIA_TYPE)
				.header(GlobalConstant.HEADER_TOKEN_KEY, GlobalConstantToJunit.ACCESS_TOKEN);
	...
	@SneakyThrows
	@Test
	public void a_listTreeByParentIdNotButton() {

		RequestBuilder request = MockMvcRequestBuilders
				.get(LIST_BY_PARENT_ID_NOT_BUTTON_URL)
				.param("parentId", "1")
				.accept(JSON_MEDIA_TYPE)
				.contentType(DEFAULT_FORM_MEDIA_TYPE)
				.header(GlobalConstant.HEADER_TOKEN_KEY, GlobalConstantToJunit.ACCESS_TOKEN);
	...
	public void a_create() {
		...
		param.setPermissionUrl(RandomUtil.randomAlphabetic(6));
		param.setPermissionTypeEnum(PermissionTypeEnum.TOP_DIRECTORY.getCode());
		param.setParentId(1L);
		param.setRanking(100);
		param.setStateEnum(StateEnum.ENABLE.getCode());
		param.setVisibleEnum(VisibleEnum.DISPLAY.getCode());
		param.setBoolExtLinkEnum(BooleanEnum.NO.getCode());
		param.setBoolNewTabEnum(BooleanEnum.NO.getCode());
