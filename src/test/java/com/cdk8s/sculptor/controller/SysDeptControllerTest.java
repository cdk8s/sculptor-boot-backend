...
public class SysDeptControllerTest {
	...
	private static final String MODULE_NAME = "sysDept";
	...
	@Test
	public void a_list() {
		SysDeptPageQueryParam param = new SysDeptPageQueryParam();
	...
	public void a_create() {
		SysDeptCreateRequestParam param = new SysDeptCreateRequestParam();
		// 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setDeptName(RandomUtil.randomAlphabetic(6));
		param.setDeptCode(RandomUtil.randomAlphabetic(6));
	...
	public void b_update() {
		SysDeptUpdateRequestParam param = new SysDeptUpdateRequestParam();
		param.setId(ID);
		// 根据业务补充其他属性：RandomUtil.randomAlphabetic(6)
		param.setDeptName(RandomUtil.randomAlphabetic(6));
		param.setDeptCode(RandomUtil.randomAlphabetic(6));
