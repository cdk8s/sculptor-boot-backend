...
public class SysLoginLogControllerTest {
	...
	public void a_create() {
		...
		param.setBoolLoginSuccessEnum(BooleanEnum.YES.getCode());
		param.setBoolNowOnlineEnum(BooleanEnum.YES.getCode());
		param.setBoolNewUserEnum(BooleanEnum.YES.getCode());
		param.setLoginOriginEnum(LoginOriginEnum.WEB.getCode());
