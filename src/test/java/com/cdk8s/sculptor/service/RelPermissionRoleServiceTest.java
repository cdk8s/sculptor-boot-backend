...
public class RelPermissionRoleServiceTest {
	...
	public void a_findOneById() {
		RelPermissionRole result = relPermissionRoleService.findOneById(ID);
	...
	public void a_findListByIdList() {
		...
		List<RelPermissionRole> result = relPermissionRoleService.findListByIdList(idList);
	...
	public void a_create() {
		...
		serviceBO.setId(ID);
		serviceBO.setPermissionId(ID);
		serviceBO.setRoleId(ID);
